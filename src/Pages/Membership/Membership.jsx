    ...
    return (
        <div>
            ...
            <div>
                ...
                <div
                    className="relative flex mx-auto mt-8 flex-col bg-clip-border rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 text-white shadow-gray-900/20 shadow-md w-full max-w-[20rem] p-8">
                    <div
